...
//---------------------------------------------------------------------------
void TSettingView::WriteToIni(TIniFile *Ini, AnsiString Section)
{
...
void TSettingView::ReadFromIni(TFastIni *Ini, AnsiString Section)
{
    ...
    m_bLabelCircleVisible = Ini->ReadBool(Section, "LabelCircleVisible", m_bLabelCircleVisible);
    m_bLabelRectangleVisible = Ini->ReadBool(Section, "LabelRectangleVisible", m_bLabelRectangleVisible);
    m_bLavelCRFocusedOnTop = Ini->ReadBool(Section, "LavelCRFocusedOnTop", m_bLavelCRFocusedOnTop);
    m_bLabelNameVisible = Ini->ReadBool(Section, "LabelNameVisible", m_bLabelNameVisible);
    m_bLabelFill = Ini->ReadBool(Section, "LabelFill", m_bLabelFill);

    m_bFocusCursor = Ini->ReadBool(Section, "FocusCursor", m_bFocusCursor);
    m_bFocusCursorAnimation = Ini->ReadBool(Section, "FocusCursorAnimation", m_bFocusCursorAnimation);
    m_nCardDefaultShape = Ini->ReadInteger(Section, "CardDefaultShape", m_nCardDefaultShape);
    m_nCardDefaultSize = Ini->ReadInteger(Section, "CardDefaultSize", m_nCardDefaultSize);
    m_bCardDefaultFixed = Ini->ReadBool(Section, "CardDefaultFixed", m_bCardDefaultFixed);
    ...
    m_nFourgroundColor = Ini->ReadInteger(Section, "FourgroundColor", m_nFourgroundColor);
    m_nBackgroundColor = Ini->ReadInteger(Section, "BackgroundColor", m_nBackgroundColor);
    ...
    m_nLinkListHeight = Ini->ReadInteger(Section, "LinkListHeight", m_nLinkListHeight);
    m_bEditorRelatedVisible = Ini->ReadBool(Section, "EditorRelatedVisible", m_bEditorRelatedVisible);
    m_nEditorRelatedWidth = Ini->ReadInteger(Section, "EditorRelatedWidth", m_nEditorRelatedWidth);
    m_nGlobalSearchWidth = Ini->ReadInteger(Section, "GlobalSearchWidth", m_nGlobalSearchWidth);

    m_bStatusBar = Ini->ReadBool(Section, "StatusBar", m_bStatusBar);

    m_bLoadImageatOnce = Ini->ReadBool(Section, "LoadImageatOnce", m_bLoadImageatOnce);
    m_bRedrawInBackground = Ini->ReadBool(Section, "RedrawInBackground", m_bRedrawInBackground);

    m_nSpecialPaint = Ini->ReadInteger(Section, "SpecialPaint", m_nSpecialPaint);
    m_SpecialCaption = Ini->ReadString(Section, "SpecialCaption", m_SpecialCaption);
}
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
void TSettingFile::WriteToIni(TIniFile *Ini, AnsiString Section)
{
    Ini->WriteBool(Section, "CheckNew", m_bCheckNew);

    for (int i = 0 ; i < 10 ; i++){
        Ini->WriteString(Section, AnsiString("History") + i, m_RecentFiles[i]);
    }
    for (int i = 0 ; i < 10 ; i++){
        Ini->WriteString(Section, AnsiString("HistoryF") + i, m_RecentFolders[i]);
    }
...
//---------------------------------------------------------------------------
void TSettingFile::ReadFromIni(TFastIni *Ini, AnsiString Section)
{
    m_bCheckNew = Ini->ReadBool(Section, "CheckNew", m_bCheckNew);

    for (int i = 0 ; i < 10 ; i++){
        m_RecentFiles[i] = Ini->ReadString(Section, AnsiString("History") + i, "");
    }
    for (int i = 0 ; i < 10 ; i++){
        m_RecentFolders[i] = Ini->ReadString(Section, AnsiString("HistoryF") + i, "");
    }
    ...
    if (m_PlugIn != ""){
        if (FileExists(m_PlugIn)){
            ...
            fepLoadPlugIn = (void __stdcall (*)(void))GetProcAddress(m_hPlugIn, "fepLoadPlugIn");
            fepTimeOut = (void __stdcall (*)(IDocCtrl *Doc))GetProcAddress(m_hPlugIn, "fepTimeOut");
            fepOperation = (bool __stdcall (*)(IDocCtrl *, char *))GetProcAddress(m_hPlugIn, "fepOperation");
            fepUnloadPlugIn = (void __stdcall (*)(void))GetProcAddress(m_hPlugIn, "fepUnloadPlugIn");
...
//---------------------------------------------------------------------------
void TSetting2Function::ReadFromIni(TFastIni *Ini)
{
