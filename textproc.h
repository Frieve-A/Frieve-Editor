...
public:
    ...
    virtual ~TDMatrix();
public:
    inline int &ID(int idx);
    inline float &S(int source, int target);
...
public:
    ...
    //参照
    inline WideString &Strings(int nindex);
...
public:
    ...
    //参照
    inline WideString &Strings(int nindex);
    inline int &Values(int nindex);
    inline bool &Enabled(int nindex);
    inline int &From(int nindex);
    inline int &To(int nindex);
    inline int &SN(int nindex);
