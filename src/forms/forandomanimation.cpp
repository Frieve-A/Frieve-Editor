...
void TFo_RandomAnimation::ApplyLanguageSetting() {
  ...
  La_Zoom->Caption =
      Ini->ReadString("RandomAnimation", "La_Zoom", La_Zoom->Caption);
  La_Speed->Caption =
      Ini->ReadString("RandomAnimation", "La_Speed", La_Speed->Caption);
  La_Cards->Caption =
      Ini->ReadString("RandomAnimation", "La_Cards", La_Cards->Caption);
  SB_FullScreen->Caption = Ini->ReadString("RandomAnimation", "SB_FullScreen",
                                           SB_FullScreen->Caption);
  SB_Pause->Caption =
      Ini->ReadString("RandomAnimation", "SB_Pause", SB_Pause->Caption);
  SB_Stop->Caption =
      Ini->ReadString("RandomAnimation", "SB_Stop", SB_Stop->Caption);
...
// ---------------------------------------------------------------------------
void __fastcall TFo_RandomAnimation::SB_StopClick(TObject *Sender) { Close(); }
