...
void TFo_Search::ApplyLanguageSetting() {
	...
	if (bReplace) {
		...
		La_ReplaceTo->Caption = Ini->ReadString("Search", "La_ReplaceTo",
			La_ReplaceTo->Caption);
	}
	else {
		Caption = Ini->ReadString("Search", "Caption", Caption);
		Ch_GlobalSearch->Caption = Ini->ReadString("Search", "Ch_GlobalSearch",
			Ch_GlobalSearch->Caption);
		Bu_FindNext->Caption = Ini->ReadString("Search", "Bu_FindNext",
			Bu_FindNext->Caption);
	}
	La_Keyword->Caption = Ini->ReadString("Search", "La_Keyword",
		La_Keyword->Caption);
	Ch_CardTitle->Caption = Ini->ReadString("Search", "Ch_CardTitle",
		Ch_CardTitle->Caption);
	Ch_Text->Caption = Ini->ReadString("Search", "Ch_Text", Ch_Text->Caption);
	Ch_MatchCase->Caption = Ini->ReadString("Search", "Ch_MatchCase",
		Ch_MatchCase->Caption);
	Ch_InvisibleCard->Caption = Ini->ReadString("Search", "Ch_InvisibleCard",
		Ch_InvisibleCard->Caption);
	Ch_Backward->Caption = Ini->ReadString("Search", "Ch_Backward",
		Ch_Backward->Caption);

	Bu_Cancel->Caption = Ini->ReadString("Dialog", "Bu_Cancel",
		Bu_Cancel->Caption);
