...
// ---------------------------------------------------------------------------
__fastcall TFo_RandomCard::TFo_RandomCard(TComponent *Owner) : TForm(Owner) {}
// ---------------------------------------------------------------------------

void __fastcall TFo_RandomCard::FormDeactivate(TObject *Sender) { Close(); }
...
// ---------------------------------------------------------------------------
void __fastcall TFo_RandomCard::SB_StopClick(TObject *Sender) { Close(); }
...
// ---------------------------------------------------------------------------
void __fastcall TFo_RandomCard::FormShow(TObject *Sender) { SettingToGUI(); }
