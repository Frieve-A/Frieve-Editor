...
TSettingView::TSettingView() {
  ...
  m_nEditInBrowserPos =
      0; // Edit position: 0=below card, 1=right of browser, 2=below browser
...
// ---------------------------------------------------------------------------
TSettingView::~TSettingView() { delete m_Font; }
...
void TSettingView::WriteToIni(TIniFile *Ini, UnicodeString Section) {
  ...
  Ini->WriteInteger(Section, "EditorHeightInBrowser", m_nEditorHeightInBrowser);

  Ini->WriteBool(Section, "Score", m_bScore);
  Ini->WriteInteger(Section, "ScoreType", m_ScoreType);

  Ini->WriteBool(Section, "Read", m_bRead);
  Ini->WriteInteger(Section, "ReadSpeed", m_nReadSpeed);
...
void TSettingView::ReadFromIni(TIniFile *Ini, UnicodeString Section) {
  ...
  m_nLinkDefaultShape =
      Ini->ReadInteger(Section, "LinkDefaultShape", m_nLinkDefaultShape);
  ...
  m_bLinkDirectionVisible =
      Ini->ReadBool(Section, "LinkDirectionVisible", m_bLinkDirectionVisible);
  m_bLinkNameVisible =
      Ini->ReadBool(Section, "LinkNameVisible", m_bLinkNameVisible);

  m_bLabelCircleVisible =
      Ini->ReadBool(Section, "LabelCircleVisible", m_bLabelCircleVisible);
  m_bLabelRectangleVisible =
      Ini->ReadBool(Section, "LabelRectangleVisible", m_bLabelRectangleVisible);
  m_bLavelCRFocusedOnTop =
      Ini->ReadBool(Section, "LavelCRFocusedOnTop", m_bLavelCRFocusedOnTop);
  m_bLabelNameVisible =
      Ini->ReadBool(Section, "LabelNameVisible", m_bLabelNameVisible);
  ...
  m_bFocusCursorAnimation =
      Ini->ReadBool(Section, "FocusCursorAnimation", m_bFocusCursorAnimation);
  m_nCardDefaultShape =
      Ini->ReadInteger(Section, "CardDefaultShape", m_nCardDefaultShape);
  m_nCardDefaultSize =
      Ini->ReadInteger(Section, "CardDefaultSize", m_nCardDefaultSize);
  m_bCardDefaultFixed =
      Ini->ReadBool(Section, "CardDefaultFixed", m_bCardDefaultFixed);
  ...
  m_bCardGradation = Ini->ReadBool(Section, "CardGradation", m_bCardGradation);
  ...
  m_bDrawingVisible =
      Ini->ReadBool(Section, "DrawingVisible", m_bDrawingVisible);
  m_nImageLimitation =
      Ini->ReadInteger(Section, "ImageLimitation", m_nImageLimitation);
  m_bMagnifyFocused =
      Ini->ReadBool(Section, "MagnifyFocused", m_bMagnifyFocused);
  ...
  m_bEditInBrowserAlways =
      Ini->ReadBool(Section, "EditInBrowserAlways", m_bEditInBrowserAlways);
  m_nEditInBrowserPos =
      Ini->ReadInteger(Section, "EditInBrowserPos", m_nEditInBrowserPos);
  m_nEditorWidthInBrowser = Ini->ReadInteger(Section, "EditorWidthInBrowser",
                                             m_nEditorWidthInBrowser);
  m_nEditorHeightInBrowser = Ini->ReadInteger(Section, "EditorHeightInBrowser",
  ...
  m_nReadSpeed = Ini->ReadInteger(Section, "ReadSpeed", m_nReadSpeed);
  m_ReadAgentFile = Ini->ReadString(Section, "ReadAgentFile", m_ReadAgentFile);

  m_bCardList = Ini->ReadBool(Section, "CardList", m_bCardList);
  m_bFileList = Ini->ReadBool(Section, "FileList", m_bFileList);

  m_nFourgroundColor =
      Ini->ReadInteger(Section, "FourgroundColor", m_nFourgroundColor);
  m_nBackgroundColor =
      Ini->ReadInteger(Section, "BackgroundColor", m_nBackgroundColor);
  ...
  m_bTileWallPaper = Ini->ReadBool(Section, "TileWallPaper", m_bTileWallPaper);

  m_bBGAnimation = Ini->ReadBool(Section, "BGAnimation", m_bBGAnimation);
  m_nBGAnimationType =
      Ini->ReadInteger(Section, "BGAnimationType", m_nBGAnimationType);
  ...
  m_nFileListWidth =
      Ini->ReadInteger(Section, "FileListWidth", m_nFileListWidth);
  m_nCardListWidth =
      Ini->ReadInteger(Section, "CardListWidth", m_nCardListWidth);
  m_nLinkListHeight =
      Ini->ReadInteger(Section, "LinkListHeight", m_nLinkListHeight);
  m_bEditorRelatedVisible =
      Ini->ReadBool(Section, "EditorRelatedVisible", m_bEditorRelatedVisible);
  m_nEditorRelatedWidth =
      Ini->ReadInteger(Section, "EditorRelatedWidth", m_nEditorRelatedWidth);
  m_nGlobalSearchWidth =
      Ini->ReadInteger(Section, "GlobalSearchWidth", m_nGlobalSearchWidth);

  m_bStatusBar = Ini->ReadBool(Section, "StatusBar", m_bStatusBar);

  m_bLoadImageatOnce =
      Ini->ReadBool(Section, "LoadImageatOnce", m_bLoadImageatOnce);
  m_bRedrawInBackground =
      Ini->ReadBool(Section, "RedrawInBackground", m_bRedrawInBackground);

  m_nSpecialPaint = Ini->ReadInteger(Section, "SpecialPaint", m_nSpecialPaint);
  m_SpecialCaption =
      Ini->ReadString(Section, "SpecialCaption", m_SpecialCaption);
}
// ---------------------------------------------------------------------------
...
void TSettingFile::WriteToIni(TIniFile *Ini, UnicodeString Section) {
  ...
  for (int i = 0; i < 10; i++) {
    Ini->WriteString(Section, UnicodeString("History") + i, m_RecentFiles[i]);
  }
  for (int i = 0; i < 10; i++) {
...
void TSettingFile::ReadFromIni(TIniFile *Ini, UnicodeString Section) {
  ...
  if (m_PlugIn != "") {
    if (FileExists(m_PlugIn)) {
      ...
      fepLoadPlugIn =
          (void __stdcall (*)(void))GetProcAddress(m_hPlugIn, "fepLoadPlugIn");
      fepTimeOut = (void __stdcall (*)(IDocCtrl * Doc))
          GetProcAddress(m_hPlugIn, "fepTimeOut");
      fepOperation = (bool __stdcall (*)(IDocCtrl *, wchar_t *))GetProcAddress(
          m_hPlugIn, "fepOperation");
      fepUnloadPlugIn = (void __stdcall (*)(void))GetProcAddress(
          m_hPlugIn, "fepUnloadPlugIn");
