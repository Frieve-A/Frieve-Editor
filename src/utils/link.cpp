...
{
    UnicodeString S =
        UnicodeString("Fr") + IntToStr(m_nFromID) +//Fr
        UnicodeString(",") +
        UnicodeString("De") + IntToStr(m_nDestID) +//De
        UnicodeString(",") +
        UnicodeString("Di") + IntToStr(m_bDirection) +//Di
        UnicodeString(",") +
        UnicodeString("Sh") + IntToStr(m_nShape);//Sh
        /*
        UnicodeString(",") +
