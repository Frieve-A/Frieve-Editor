...
//---------------------------------------------------------------------------
//高速Ini
TFastIniSection::TFastIniSection(UnicodeString Name, TStringList *SL, int start, int end) :
    m_Name(Name),
    m_nLastIndex(-1)
{
...
UnicodeString TFastIniSection::ReadString(UnicodeString Key, UnicodeString Default)
{
...
TFastIni::TFastIni(UnicodeString FN) :
    m_LastSectionIndex(-1)
{
    m_Sections = new TList();
...
UnicodeString TFastIni::ReadString(UnicodeString Section, UnicodeString Key, UnicodeString Default)
{
...
float TFastIni::ReadFloat(UnicodeString Section, UnicodeString Key, float Default)
{
    TFastIniSection *FIS = SearchSection(Section);
    if (FIS){
...
//---------------------------------------------------------------------------
void FileListCreator(UnicodeString TopDir, TStringList *SL, UnicodeString Exts, bool SubFolder)
{
    void *Handle;
    TWin32FindData Data;
    Exts = UpperCase(Exts);
