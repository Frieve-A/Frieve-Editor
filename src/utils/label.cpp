...
{
    return
        UnicodeString("Co") + IntToStr(m_nColor) +//Co
        UnicodeString(",") +
        UnicodeString("En") + IntToStr(m_bEnable) +//En
        UnicodeString(",") +
        UnicodeString("Sh") + IntToStr(m_bShow) +//Sh
        UnicodeString(",") +
        UnicodeString("Hi") + IntToStr(m_bHide) +//Hi
        UnicodeString(",") +
        UnicodeString("Fo") + IntToStr(m_bFold) +//Fo
        UnicodeString(",") +
        UnicodeString("Si") + IntToStr(m_nSize) +//Si
        UnicodeString(",") +
        UnicodeString("Na") + m_Name;//Na
}
//---------------------------------------------------------------------------
