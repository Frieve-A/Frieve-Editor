...
WideString SplitStrBy(WideString &S,
                      WideString SplitChar); // Split S at SplitChar position
...
UnicodeString
ForFileName(UnicodeString S); // Remove chars invalid for filenames
UnicodeString
DeleteActionKey(UnicodeString S); // Remove action key strings like &File, (&F)
// ---------------------------------------------------------------------------
// Color related
